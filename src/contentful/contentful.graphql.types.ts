...
/** [See type definition](https://app.contentful.com/spaces/fydf0o2ery42/content_types/experience) */
export type ExperienceCoordinatesArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};
