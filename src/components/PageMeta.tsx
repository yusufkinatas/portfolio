...
export function PageMeta(props: { description?: string | null; image?: string | null }) {
  ...
  return (
    <Head>
      {props.description && (
        <Fragment>
          <meta key="description" name="description" property="description" content={props.description} />
